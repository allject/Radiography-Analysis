...
* 📦 **Neueste Version (Release):** [v1.2.0](https://github.com/allject/Radiography-Analysis/releases/tag/v1.2.0)
* 💾 **Direkter Download (.zip):** [v1.2.0 Herunterladen](https://github.com/allject/Radiography-Analysis/archive/refs/tags/v1.2.0.zip)
...
1. Open `radiography-analysis.html` locally, download the [Latest ZIP](https://github.com/allject/Radiography-Analysis/archive/refs/tags/v1.2.0.zip), or access it via [GitHub Pages](https://allject.github.io/Radiography-Analysis/).
...
This package represents the latest stable GitHub release for **Radiography Analysis**. It includes improved mobile and tablet compatibility, enhanced workflow stability, additional analysis parameters, expanded multilingual documentation, responsive UI refinements, and multiple bug fixes.
...
* Improved ROI interaction, workflow consistency, and calculation reliability.
